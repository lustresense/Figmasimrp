...
// Source: Data Resmi Kementerian Dalam Negeri & Pos Indonesia
// SEMUA KODE POS SURABAYA - NO MISSING DATA!
  ...
  kecamatan: [
    ...
    },
    {
      ...
      kelurahan: [
        ...
        { kode: '3578030003', nama: 'Jepara', kodepos: ['60175'] },
        { kode: '3578030004', nama: 'Alun-Alun Contong', kodepos: ['60176'] },
    ...
    },
    {
      ...
      kelurahan: [
        ...
        { kode: '3578040002', nama: 'Tambakrejo', kodepos: ['60141'] },
        { kode: '3578040003', nama: 'Kapasan', kodepos: ['60142'] },
    ...
    },
    {
      ...
      kelurahan: [
        ...
        { kode: '3578050002', nama: 'Krembangan Utara', kodepos: ['60175'] },
        { kode: '3578050003', nama: 'Perak Barat', kodepos: ['60165'] },
        { kode: '3578050004', nama: 'Perak Timur', kodepos: ['60164'] },
        { kode: '3578050005', nama: 'Nyamplungan', kodepos: ['60162'] }
      ]
    },
    // SURABAYA TIMUR
    {
    ...
    },
    {
      ...
      kelurahan: [
        ...
        { kode: '3578070004', nama: 'Penjaringansari', kodepos: ['60299'] },
        { kode: '3578070005', nama: 'Kedung Baruk', kodepos: ['60298'] },
        { kode: '3578070006', nama: 'Rungkut Kidul', kodepos: ['60297'] }
      ]
    },
    {
      kode: '3578080',
    ...
    },
    {
      ...
      kelurahan: [
        ...
        { kode: '3578100004', nama: 'Medokan Semampir', kodepos: ['60111'] },
    ...
    },
    {
      ...
      kelurahan: [
        ...
        { kode: '3578110004', nama: 'Dukuh Sutorejo', kodepos: ['60113'] },
        { kode: '3578110005', nama: 'Kebon Agung', kodepos: ['60116'] },
    ...
    // SURABAYA BARAT
    {
      ...
      kelurahan: [
        ...
        { kode: '3578120005', nama: 'Putat Jaya', kodepos: ['60189'] },
        { kode: '3578120006', nama: 'Kupang Krajan', kodepos: ['60189'] }
      ]
    },
    {
      kode: '3578130',
      ...
      kelurahan: [
        ...
        { kode: '3578130003', nama: 'Dupak', kodepos: ['60177'] },
        { kode: '3578130004', nama: 'Perak Utara', kodepos: ['60177'] },
    ...
    },
    {
      ...
      kelurahan: [
        ...
        { kode: '3578140002', nama: 'Genting', kodepos: ['60183'] },
        { kode: '3578140003', nama: 'Tambakrejo', kodepos: ['60184'] },
        { kode: '3578140004', nama: 'Greges', kodepos: ['60191'] }
      ]
    },
    {
      kode: '3578150',
      nama: 'Benowo',
      kelurahan: [
        { kode: '3578150001', nama: 'Sememi', kodepos: ['60185'] },
        { kode: '3578150002', nama: 'Kandangan', kodepos: ['60199'] },
        { kode: '3578150003', nama: 'Romokalisari', kodepos: ['60195'] },
        { kode: '3578150004', nama: 'Tambak Oso Wilangun', kodepos: ['60197'] }
      ]
    },
    {
      kode: '3578160',
      nama: 'Pakal',
      kelurahan: [
        { kode: '3578160001', nama: 'Pakal', kodepos: ['60197'] },
        { kode: '3578160002', nama: 'Sumber Rejo', kodepos: ['60196'] },
        { kode: '3578160003', nama: 'Babat Jerawat', kodepos: ['60195'] },
        { kode: '3578160004', nama: 'Benowo', kodepos: ['60198'] }
      ]
    },
    {
      kode: '3578170',
      nama: 'Lakarsantri',
      kelurahan: [
        { kode: '3578170001', nama: 'Bangkingan', kodepos: ['60213'] },
        { kode: '3578170002', nama: 'Jeruk', kodepos: ['60231'] },
        { kode: '3578170003', nama: 'Lakarsantri', kodepos: ['60215'] },
        { kode: '3578170004', nama: 'Lidah Kulon', kodepos: ['60213'] },
        { kode: '3578170005', nama: 'Lidah Wetan', kodepos: ['60213'] },
        { kode: '3578170006', nama: 'Sumur Welut', kodepos: ['60216'] }
      ]
    },
    {
      kode: '3578180',
      ...
      kelurahan: [
        ...
        { kode: '3578180003', nama: 'Bringin', kodepos: ['60219'] },
    ...
    },
    {
      ...
      nama: 'Tandes',
      kelurahan: [
        { kode: '3578190001', nama: 'Tandes', kodepos: ['60186'] },
        { kode: '3578190002', nama: 'Balongsari', kodepos: ['60188'] },
        { kode: '3578190003', nama: 'Manukan Wetan', kodepos: ['60185'] },
        { kode: '3578190004', nama: 'Manukan Kulon', kodepos: ['60185'] },
        { kode: '3578190005', nama: 'Banjar Sugihan', kodepos: ['60187'] },
        { kode: '3578190006', nama: 'Karang Poh', kodepos: ['60189'] }
      ]
    },
    {
      kode: '3578200',
      ...
      kelurahan: [
        ...
        { kode: '3578200005', nama: 'Sonokwijenan', kodepos: ['60282'] },
    ...
    // SURABAYA UTARA
    {
      ...
      nama: 'Bulak',
      kelurahan: [
        { kode: '3578210001', nama: 'Bulak', kodepos: ['60121'] },
        { kode: '3578210002', nama: 'Kedung Cowek', kodepos: ['60128'] },
        { kode: '3578210003', nama: 'Kenjeran', kodepos: ['60127'] },
    ...
    },
    {
      ...
      nama: 'Kenjeran',
      kelurahan: [
        { kode: '3578220001', nama: 'Bulak Banteng', kodepos: ['60125'] },
        { kode: '3578220002', nama: 'Tanah Kali Kedinding', kodepos: ['60129'] },
        { kode: '3578220003', nama: 'Sidotopo Wetan', kodepos: ['60126'] },
        { kode: '3578220004', nama: 'Tambak Wedi', kodepos: ['60128'] }
      ]
    },
    {
      kode: '3578230',
      ...
      kelurahan: [
        ...
        { kode: '3578230002', nama: 'Pegirian', kodepos: ['60243'] },
        { kode: '3578230003', nama: 'Sidotopo', kodepos: ['60149'] },
        { kode: '3578230004', nama: 'Wonokusumo', kodepos: ['60155'] },
    ...
    // SURABAYA SELATAN
    {
      ...
      kelurahan: [
        ...
        { kode: '3578240004', nama: 'Ngagelrejo', kodepos: ['60245'] },
        { kode: '3578240005', nama: 'Jagir', kodepos: ['60244'] },
        { kode: '3578240006', nama: 'Sawunggaling', kodepos: ['60251'] }
      ]
    },
    {
      kode: '3578250',
      ...
      kelurahan: [
        ...
        { kode: '3578250003', nama: 'Sidosermo', kodepos: ['60291'] },
    ...
    },
    {
      ...
      kelurahan: [
        ...
        { kode: '3578260002', nama: 'Balas Klumprik', kodepos: ['60229'] },
        { kode: '3578260003', nama: 'Babatan', kodepos: ['60227'] },
        { kode: '3578260004', nama: 'Jajar Tunggal', kodepos: ['60252'] }
      ]
    },
    {
      kode: '3578270',
      ...
      kelurahan: [
        ...
        { kode: '3578270004', nama: 'Warugunung', kodepos: ['60224'] }
      ]
    },
    {
      kode: '3578280',
      nama: 'Jambangan',
      kelurahan: [
        { kode: '3578280001', nama: 'Jambangan', kodepos: ['60233'] },
        { kode: '3578280002', nama: 'Karah', kodepos: ['60232'] },
        { kode: '3578280003', nama: 'Kebonsari', kodepos: ['60233'] },
        { kode: '3578280004', nama: 'Pagesangan', kodepos: ['60234'] }
      ]
    },
    {
      kode: '3578290',
    ...
    },
    {
      ...
      kelurahan: [
        ...
        { kode: '3578300003', nama: 'Gunung Sari', kodepos: ['60226'] },
    ...
    },
    {
      ...
      nama: 'Tambaksari',
      kelurahan: [
        { kode: '3578310001', nama: 'Tambaksari', kodepos: ['60136'] },
        { kode: '3578310002', nama: 'Rangkah', kodepos: ['60132'] },
        { kode: '3578310003', nama: 'Gading', kodepos: ['60134'] },
        { kode: '3578310004', nama: 'Kapas Madya', kodepos: ['60131'] },
        { kode: '3578310005', nama: 'Dukuh Setro', kodepos: ['60133'] },
        { kode: '3578310006', nama: 'Pacar Keling', kodepos: ['60131'] },
        { kode: '3578310007', nama: 'Ploso', kodepos: ['60137'] }
      ]
    }
  ]
};
